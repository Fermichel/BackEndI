window.addEventListener('load', function () {
      ...
      //recorremos la colección de peliculas del JSON
         for(paciente of data){
            ...
            let deleteButton = '<button' +
                                      ...
                                      ' type="button" onclick="deleteBy('+paciente.id+')" class="btn rounded-circle btn-danger btn_delete">' +
                                      '&times' +
                                      '</button>';
            ...
            let updateButton = '<button' +
                                      ...
                                      ' type="button" onclick="findBy('+paciente.id+')" class="btn btn-primary rounded-circle btn-success btn_id">' +
                                      paciente.id +
                                      '</button>';
    ...
    (function(){
      ...
      if (pathname == "/pacienteFunciones.html") {
