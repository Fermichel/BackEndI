window.addEventListener('load', function () {
      ...
      //recorremos la colección de peliculas del JSON
         for(odontologo of data){
            ...
            let deleteButton = '<button' +
                                      ...
                                      ' type="button" onclick="deleteBy('+odontologo.id+')" class="btn rounded-circle btn-danger btn_delete">' +
                                      '&times' +
                                      '</button>';
            ...
            let updateButton = '<button' +
                                      ...
                                      ' type="button" onclick="findBy('+odontologo.id+')" class="btn btn-primary rounded-circle btn-success btn_id">' +
                                      odontologo.id +
                                      '</button>';
    ...
    (function(){
      ...
      if (pathname == "/odontologoFunciones.html") {
